...
export const metadata: Metadata = {
  title: 'Local Eats - Your Local Restaurants, Delivered Affordably',
  description: 'Local Eats connects you with your favorite local eateries, offering lower fees and a focus on community. موسى',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="1d454133-7252-4032-894a-a2fb0659a3b061dc83a111021d46aaba76b11e196a18";
